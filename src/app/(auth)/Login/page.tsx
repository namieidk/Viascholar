...
export default function LoginPage() {
  return (
    ...
    >
      ...
      {/* Dynamic Glows for depth */}
      <div className="absolute top-[-10%] right-[5%] w-[500px] h-[500px] bg-sky-500/10 rounded-full blur-[120px]" />
      ...
      <p className="absolute bottom-6 text-gray-700 text-[9px] font-black uppercase tracking-[0.4em] z-10">
        ViaScholar Unified System • Davao City
      </p>
    </div>
  );
}